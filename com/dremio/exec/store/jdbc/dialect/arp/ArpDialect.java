...
public class ArpDialect extends JdbcDremioSqlDialect {
   ...
   public static class ArpSchemaFetcher extends JdbcSchemaFetcher {
      ...
      public ArpSchemaFetcher(String query, String name, DataSource dataSource, int timeout, JdbcStoragePlugin.Config config) {
      ...
      public ArpSchemaFetcher(String query, String name, DataSource dataSource, int timeout, JdbcStoragePlugin.Config config, boolean usePrepareForColumnMeta, boolean usePrepareForGetTables) {
         super(name, dataSource, timeout, config);
         this.query = query;
      ...
      public DatasetHandleListing getTableHandles() {
         if (this.config.shouldSkipSchemaDiscovery()) {
            ...
            try {
               ...
               return new JdbcSchemaFetcher.JdbcIteratorListing(new ArpDialect.ArpSchemaFetcher.ArpJdbcDatasetMetadataIterable(this.storagePluginName, connection, this.filterQuery(this.query, connection.getMetaData())));
      ...
      protected static class ArpJdbcDatasetMetadataIterable extends AbstractIterator<DatasetHandle> implements AutoCloseable {
         ...
         protected ArpJdbcDatasetMetadataIterable(String storagePluginName, Connection connection, String query) {
