...
public class MSSQLDialect extends ArpDialect {
   ...
   public ArpDialect.ArpSchemaFetcher getSchemaFetcher(String name, DataSource dataSource, int timeout, JdbcStoragePlugin.Config config) {
      return new MSSQLDialect.MSSQLSchemaFetcher(config.getHiddenSchemas(), name, dataSource, timeout, config);
   }
   ...
   private static final class MSSQLSchemaFetcher extends ArpDialect.ArpSchemaFetcher {
      ...
      private MSSQLSchemaFetcher(Set<String> hiddenSchemas, String name, DataSource dataSource, int timeout, JdbcStoragePlugin.Config config) {
      ...
      public long getRowCount(JdbcSchemaFetcher.JdbcDatasetHandle handle) {
