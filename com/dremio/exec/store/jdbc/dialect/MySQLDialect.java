...
public final class MySQLDialect extends ArpDialect {
   ...
   public MySQLDialect.MySQLSchemaFetcher getSchemaFetcher(String name, DataSource dataSource, int timeout, JdbcStoragePlugin.Config config) {
      ...
      return new MySQLDialect.MySQLSchemaFetcher(query, name, dataSource, timeout, config);
   }
   ...
   private static final class MySQLSchemaFetcher extends ArpDialect.ArpSchemaFetcher {
      ...
      private MySQLSchemaFetcher(String query, String name, DataSource dataSource, int timeout, JdbcStoragePlugin.Config config) {
         super(query, name, dataSource, timeout, config);
      }

      protected long getRowCount(JdbcSchemaFetcher.JdbcDatasetHandle handle) {
         List<String> tablePath = handle.getIdentifiers();
