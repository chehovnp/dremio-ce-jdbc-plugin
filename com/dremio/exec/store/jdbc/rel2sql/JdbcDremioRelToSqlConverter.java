      ...
      public SqlNode field(int ordinal) {
         ...
         for(Iterator var2 = this.getAliases().entrySet().iterator(); var2.hasNext(); ordinal -= fields.size()) {
            ...
            if (ordinal < fields.size()) {
               ...
               SqlCollation collation = field.getType().getSqlTypeName().getFamily() == SqlTypeFamily.CHARACTER ? JdbcDremioRelToSqlConverter.this.getDialect().getDefaultCollation(SqlKind.IDENTIFIER) : null;
